...
{
    /// <summary>
    /// from http://www.diogonunes.com/blog/calling-a-web-method-in-c-without-a-service-reference/
    ...
    public class WebServiceAPI
    {
        ...
        public WebServiceAPI(string baseUrl)
        {
            Url = baseUrl;
            Method = String.Empty;
        }
        public WebServiceAPI(string baseUrl, string methodName)
        {
            Url = baseUrl;
            Method = methodName;
        }
        ...
        private void ExtractResult(string methodName)
        {
            ...
            if (webMethodResult.FirstNode.NodeType == XmlNodeType.Element)
            {
                ...
                ResultXML = UtilsProxyAPI.RemoveNamespaces(ResultXML);
        ...
        private void Invoke(string methodName, bool encode)
        {
            ...
            using (StreamReader responseReader = new StreamReader(req.GetResponse().GetResponseStream()))
            {
                ...
                ResponseSOAP = XDocument.Parse(UtilsProxyAPI.UnescapeString(result));
